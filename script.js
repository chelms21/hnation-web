...
function subclicker() {
Turbolinks.visit("/games/subclicker.html", { action: "replace" })
}

function home(){
Turbolinks.visit("/index.html", { action: "replace" })
}
...
set('number-video', 'numAd');
import { set } from 'idb-keyval';

set('number-spb', 'numWorker');
import { set } from 'idb-keyval';

set('number-gpb', 'numMachine');
import { set } from 'idb-keyval';

set('number-dpb', 'numFactory');
import { set } from 'idb-keyval';

set('number-cca', 'numRobofactory');
import { set } from 'idb-keyval';

set('number-rdca', 'numBeltfactory');
import { set } from 'idb-keyval';

set('number-product', 'totalProduction');
import { set } from 'idb-keyval';

set('number-money', 'userMoney');
}
...
// logs: "world"
get('number-video').then((val) => console.log(val));
import { get } from 'idb-keyval';

// logs: "world"
get('number-spb').then((val) => console.log(val));
import { get } from 'idb-keyval';

// logs: "world"
get('number-gpb').then((val) => console.log(val));
import { get } from 'idb-keyval';

// logs: "world"
get('number-dpb').then((val) => console.log(val));
import { get } from 'idb-keyval';

// logs: "world"
get('number-cca').then((val) => console.log(val));
import { get } from 'idb-keyval';

// logs: "world"
get('number-rdca').then((val) => console.log(val));
import { get } from 'idb-keyval';

// logs: "world"
get('number-product').then((val) => console.log(val));
import { get } from 'idb-keyval';

// logs: "world"
get('number-money').then((val) => console.log(val));
}
